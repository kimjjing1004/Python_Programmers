...
while count < 9:
    ...
    for i in range(len(board)):
        print(board[i])
        # 승리 조건(Player1)
        if (board[i][0] == board[i][1] and board[i][0] == board[i][2] and board[i][0] == 'O') or \
                (board[0][i] == board[1][i] and board[0][i] == board[2][i] and board[0][i] == 'O') or \
            ...
            break
        # 승리 조건(Player2)
        elif (board[i][0] == board[i][1] and board[i][0] == board[i][2] and board[i][0] == 'X') or \
                (board[0][i] == board[1][i] and board[0][i] == board[2][i] and board[0][i] == 'X') or \
